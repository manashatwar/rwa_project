              ...
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardHeader className="border-b border-gray-100">
                  ...
                  <CardDescription className="text-base">
                    Provide details about the asset you want to tokenize
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-6 p-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="w-8 h-8 border-2 border-blue-200 bg-blue-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="w-8 h-8 border-2 border-yellow-200 bg-yellow-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Our team verifies your asset details
                        </p>
                      </div>
                    </div>

                    <div className="flex items-start gap-4">
                      <div className="w-8 h-8 border-2 border-green-200 bg-green-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Asset becomes available for lending
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  <ul className="space-y-3 text-sm text-gray-600">
                    <li className="flex items-center gap-3">
                      ...
                      <span>Asset must be owned by you</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-blue-600 rounded-full" />
                      <span>Minimum value of $10,000</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-blue-600 rounded-full" />
                      <span>Valid ownership documentation</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-blue-600 rounded-full" />
                      <span>Asset location verification</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border border-blue-200 shadow-lg bg-gradient-to-br from-blue-50/50 to-purple-50/50">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                    Our team is here to guide you through the tokenization
                    process.
                  </p>
